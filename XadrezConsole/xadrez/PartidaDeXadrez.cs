...
namespace xadrez
{
    class PartidaDeXadrez
    {
        ...
        public void realizaJogada(Posicao origem, Posicao destino)
        {
            ...
            terminada = testeXequemate(adversaria(jogadorAtual)) ? true : false;

            turno++;
            mudaJogador();

           //Jogada En Passant
            VuneravelEnPassant = p is Peao && (destino.linha == origem.linha - 2 || destino.linha == origem.linha + 2) ? p : null;
        }
        ...
        public void validarPosicacoDeDestino(Posicao origem, Posicao destino)
        {
        ...
        {
            jogadorAtual = jogadorAtual != Cor.Branca ? jogadorAtual = Cor.Branca : jogadorAtual = Cor.Preta;
        }
        ...
        private void colocarPecas()
        {
            ...
            colocarNovaPeca('b', 6, new Peao(tab, Cor.Branca, this));
            ...
            colocarNovaPeca('a', 3, new Peao(tab, Cor.Preta, this));
